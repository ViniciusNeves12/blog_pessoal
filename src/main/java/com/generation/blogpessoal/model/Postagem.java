...
public class Postagem {
	 ...
	 * 
	 * A opção GenerationType.IDENTITY indica que será uma sequência numérica
	 * iniciando em 1 e será responsabilidade do Banco de dados gerar esta
	 * sequência, ou seja, a propriedade auto_increment do SQL.
	 * 
	 ...
	 * 
	 * O parâmtero message insere uma mensagem que será exibida caso o atributo seja
	 * nulo
	 * 
	 * A anotação @NotBlank indica que um atributo não pode ser nulo e também não
	 * pode ser deixado em branco (vazio).
	 * 
